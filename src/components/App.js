...
class App extends Component {
  ...
  updateTrayText = title => {
    ...
    // we want to show the title next to the Tray icon
  };

  timerHasExpired = () => {
    ipcRenderer.send('update-timer', '');
    // since the timer has expired, we don't want to show any text next to the Tray icon
    // hence sending empty string
  };
